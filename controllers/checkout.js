...
// Viết hoa các chữ cái đầu tên khách hàng                     
QS('#name').onchange = () => {
    let value = QS('#name').value
    QS('#name').value = capitalize(value)
}
...
<p style="margin:0">Thư này được gửi từ <a href= "#">Smart Point</a></p>
