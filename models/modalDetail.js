    ...
    <div class="modal-dialog" role="document">
        ...
        <div class="col-7 text-left">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-success btn-buy" data-product='${JSON.stringify(product)}' data-dismiss="modal"><i class="fa fa-shopping-cart"></i> Thêm vào giỏ</button>
            </div>
        </div>
    </div>
</div>
